    ...
    <div class="contact-head">
      <div class="head-content">
        ...
        <div class="contact_call">
          ...
          <h2><a href="#"><i class="fas fa-envelope"></i> Smilesformiles@tourism </a></h2>
        </div>
      </div>
    </div>
    ...
    <div class="offices-area">
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            <li><i class="fas fa-user-alt"></i> Mr.Aditya Lambat</li>
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Nagpursfm@tourism </li>
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            ...
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Punesfm@tourism</li>
            <li><i class="fas fa-building"></i> 5th floor, lokmat building, dhantoli</li>
            <li><i class="fas fa-map-marker-alt"></i> <a href="#"> Get Directions </a></li>
          </ul>
          <hr class="contact-time">
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            <li><i class="fas fa-user-alt"></i> Mrs.Sakshi Bannagare</li>
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Mumbaisfm@tourism</li>
            <li><i class="fas fa-building"></i> 5th floor, lokmat building, dhantoli</li>
            <li><i class="fas fa-map-marker-alt"></i> <a href=""> Get Directions</a></li>
          </ul>
          <hr class="contact-time">
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            ...
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Bangaloresfm@tourism </li>
            <li><i class="fas fa-building"></i> 5th floor, lokmat building, dhantoli </li>
            <li><i class="fas fa-map-marker-alt"></i> <a href="#"> Get Directions</a></li>
          </ul>
          <hr class="contact-time">
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            <li><i class="fas fa-user-alt"></i> Mr.richard primault</li>
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Hyderabadsfm@tourism </li>
            <li><i class="fas fa-building"></i> 5th floor, lokmat building, dhantoli </li>
            <li><i class="fas fa-map-marker-alt"></i> <a href="#"> Get Directions</a></li>
          </ul>
          <hr class="contact-time">
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            <li><i class="fas fa-user-alt"></i> Mr.richard primault</li>
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Delhisfm@tourism </li>
            <li><i class="fas fa-building"></i> 5th floor, lokmat building, dhantoli </li>
            <li><i class="fas fa-map-marker-alt"></i> <a href="#"> Get Directions</a></li>
          </ul>
          <hr class="contact-time">
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            <li><i class="fas fa-user-alt"></i> Mr.richard primault</li>
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Kolkatasfm@tourism </li>
            <li><i class="fas fa-building"></i> 5th floor, lokmat building, dhantoli </li>
            <li><i class="fas fa-map-marker-alt"></i> <a href="#"> Get Directions</a></li>
          </ul>
          <hr class="contact-time">
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            <li><i class="fas fa-user-alt"></i> Mr.richard primault</li>
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Chennaisfm@tourism </li>
            <li><i class="fas fa-building"></i> 5th floor, lokmat building, dhantoli </li>
            <li><i class="fas fa-map-marker-alt"></i> <a href="#"> Get Directions</a></li>
          </ul>
          <hr class="contact-time">
      ...
      <div class="offices">
        ...
        <div class="office-body">
          <ul>
            <li><i class="fas fa-user-alt"></i> Mr.richard primault</li>
            <li><i class="fas fa-phone"></i> <a href="#"> +91 7666331959 </a></li>
            <li><i class="fas fa-envelope"></i> Ahmedabadsfm@tourism </li>
            <li><i class="fas fa-building"></i> 5th floor, lokmat building, dhantoli </li>
            <li><i class="fas fa-map-marker-alt"></i> <a href="#"> Get Directions</a></li>
          </ul>
          <hr class="contact-time">
